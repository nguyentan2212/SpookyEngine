...
shared_ptr<KeyboardClass> KeyboardClass::instance = nullptr;
...
shared_ptr<KeyboardClass> KeyboardClass::GetInstance()
{
	if (instance == nullptr)
	{
		instance = shared_ptr<KeyboardClass>(new KeyboardClass());
	}
	return instance;
}
